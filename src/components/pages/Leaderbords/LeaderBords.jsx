...
export default function LeaderBords() {
  return (
    <section className="leaderBords">
      <div className="leaderBords__top">
        <h2 className="leaderBords__title">Лидер-борд</h2>
        {/* top */}
        <div className="w-[80%] m-auto mt-3">
          <div className="flex justify-between">
            <div className="flex text-[#fff] gap-4">
              <p className="text-[12px]">#</p>
              <h3 className="text-[12px]">Игрок</h3>
            </div>
            <div className="flex text-[#fff] items-center gap-1 text-[12px]">
              Заработано
              <svg
                width="14"
                height="14"
        ...
        <div className="flex flex-col gap-1">
          <LeaderItems className={'bg-[#262626] text-white'} titleColor={'#FEAC3E'} />
          <LeaderItems className={'bg-[#262626] text-white'} titleColor={'#FEAC3E'} />
          <LeaderItems className={'bg-[#262626] text-white'} titleColor={'#FEAC3E'} />
          {/* <LeaderItems/>
        <LeaderItems/> */}
      ...
      <div className="flex flex-col mt-[4px] gap-1">
        <LeaderItems className={'bg-[#FEAC3E]'} />
        <LeaderItems className={'bg-[#FEAC3E]'} />
        <LeaderItems className={'bg-[#FEAC3E]'} />
        <LeaderItems className={'bg-[#FEAC3E]'} />
        <LeaderItems className={'bg-[#FEAC3E]'} />
